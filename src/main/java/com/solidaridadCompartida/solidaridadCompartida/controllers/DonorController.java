...
public class DonorController {
 ...
 @PostMapping("/form") 
 public String formDonor(@RequestParam String username,@RequestParam String password, @RequestParam String email, @RequestParam String name, @RequestParam String donor_type, @RequestParam Integer voluntary){
