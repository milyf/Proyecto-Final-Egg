...
public class DonorService implements UserDetailsService {
    ...
    @Transactional
    public void createDonor(String email, String password, String password2,
            String name, String donor_type, Boolean voluntary, String voluntaryType) throws MyException {
        ...
        donor.setVoluntaryType(voluntaryType);
    ...
    public void modifyDonor(String email, String password, String name, Boolean voluntary, String voluntaryType) throws MyException {
